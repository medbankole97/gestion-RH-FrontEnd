<!-- src/components/TimeTrackingEdit.vue -->
<template>
  ...
  onMounted(async () => {
    ...
    const timeTracking = await timeTrackingStore.getById(route.params.id);
    timeTrackingForm.value = { ...timeTracking };
  });
  
  const handleSubmit = async () => {
    try {
      await timeTrackingStore.update(route.params.id, timeTrackingForm.value);
